...
#include "flat_land_1000km_testclass.h"
...
TEST_F(FlatLand1000kmProfileTests, ClutterModelTests_calcHeightGainModelHeightsTest){
...
TEST_F(FlatLand1000kmProfileTests, AnomalousProp_calcAnomalousPropLossTest){
