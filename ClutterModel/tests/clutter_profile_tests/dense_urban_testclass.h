...
#ifndef TEST_PROFILE_DENSE_URBAN_H
#define TEST_PROFILE_DENSE_URBAN_H
...
class UrbanProfileTests : public testing::Test {
protected:
	UrbanProfileTests() {}
	...
	static void SetUpTestCase() {
        K_PATH = PathProfile::Path((CMAKE_CLEARAIR_SRC_DIR 
						...
						/ std::filesystem::path("test_profile_flat_land_5km_Dense_Urban.csv")).string());
	}
    ...
    static constexpr ClutterModel::ClutterType TX_CLUTTER_TYPE = ClutterModel::ClutterType::DenseUrban;
    static constexpr ClutterModel::ClutterType RX_CLUTTER_TYPE = ClutterModel::ClutterType::DenseUrban;
...
#endif /* TEST_PROFILE_DENSE_URBAN_H */