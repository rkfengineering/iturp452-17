...
public:
    ...
    //Get total transmission loss for clear air conditions
...
private:
    ...
    //final value
    double m_totalTransmissionLoss_dB;  //total transmission loss for clear air conditions
    ...
    /// @param path Profile path of distance (km) and height (asl) (m) points
