...
protected:
	...
	static void SetUpTestCase() {
        K_PATH = PathProfile::Path(CMAKE_CLEARAIR_SRC_DIR 
						...
						/ std::filesystem::path("test_profile_flat_land_5km_Dense_Urban.csv"));
	}
    ...
    static constexpr ClearAirModel::ClutterType TX_CLUTTER_TYPE = ClearAirModel::ClutterType::DenseUrban;
    static constexpr ClearAirModel::ClutterType RX_CLUTTER_TYPE = ClearAirModel::ClutterType::DenseUrban;
