...
#include "test_profile_flat_land_5km.h"
...
TEST_F(FlatLand5kmProfileTests, ClutterLossTests_calcHeightGainModelHeightsTest){
...
TEST_F(FlatLand5kmProfileTests, AnomolousProp_calcAnomolousPropLossTest){
