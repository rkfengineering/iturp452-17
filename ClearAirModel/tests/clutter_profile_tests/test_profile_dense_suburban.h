...
#ifndef TEST_PROFILE_DENSE_SUBURBAN_H
#define TEST_PROFILE_DENSE_SUBURBAN_H
...
class SuburbanProfileTests : public testing::Test {
protected:
	SuburbanProfileTests() {}
	...
	static void SetUpTestCase() {
        K_PATH = PathProfile::Path(CMAKE_CLEARAIR_SRC_DIR 
						...
						/ std::filesystem::path("test_profile_flat_land_5km_Dense_Suburban.csv"));
	}
    ...
    static constexpr ClearAirModel::ClutterType TX_CLUTTER_TYPE = ClearAirModel::ClutterType::DenseSuburban;
    static constexpr ClearAirModel::ClutterType RX_CLUTTER_TYPE = ClearAirModel::ClutterType::DenseSuburban;
...
#endif /* TEST_PROFILE_DENSE_SUBURBAN_H */