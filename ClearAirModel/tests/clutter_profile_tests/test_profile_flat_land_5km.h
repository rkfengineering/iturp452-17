#ifndef TEST_PROFILE_FLAT_LAND_5KM_H
#define TEST_PROFILE_FLAT_LAND_5KM_H
...
class FlatLand5kmProfileTests : public testing::Test {
protected:
	FlatLand5kmProfileTests() {}
	...
	static void SetUpTestCase() {
        K_PATH = PathProfile::Path(CMAKE_CLEARAIR_SRC_DIR 
						...
						/ std::filesystem::path("test_profile_flat_land_5km.csv"));
	}
...
#endif /* TEST_PROFILE_FLAT_LAND_5KM_H */