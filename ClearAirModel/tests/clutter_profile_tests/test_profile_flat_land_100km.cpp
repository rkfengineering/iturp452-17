...
#include "test_profile_flat_land_100km.h"
...
TEST_F(FlatLand100kmProfileTests, ClutterLossTests_calcHeightGainModelHeightsTest){
...
TEST_F(FlatLand100kmProfileTests, AnomolousProp_calcAnomolousPropLossTest){
