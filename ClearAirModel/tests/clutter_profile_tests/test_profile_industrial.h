...
protected:
    ...
    static constexpr ClearAirModel::ClutterType TX_CLUTTER_TYPE = ClearAirModel::ClutterType::IndustrialZone;
    static constexpr ClearAirModel::ClutterType RX_CLUTTER_TYPE = ClearAirModel::ClutterType::IndustrialZone;
