#ifndef TEST_PROFILE_FLAT_LAND_100KM_H
#define TEST_PROFILE_FLAT_LAND_100KM_H
...
class FlatLand100kmProfileTests : public testing::Test {
protected:
	FlatLand100kmProfileTests() {}
	...
	static void SetUpTestCase() {
        K_PATH = PathProfile::Path(CMAKE_CLEARAIR_SRC_DIR 
						...
						/ std::filesystem::path("test_profile_flat_land_100km.csv"));
	}
    ...
    static constexpr ClearAirModel::ClutterType TX_CLUTTER_TYPE = ClearAirModel::ClutterType::NoClutter;
    static constexpr ClearAirModel::ClutterType RX_CLUTTER_TYPE = ClearAirModel::ClutterType::NoClutter;
...
#endif /* TEST_PROFILE_FLAT_LAND_100KM_H */